...
export const COMPOSED_PRESETS: Record<string, PaintedGlyph> = {
  ...
  // --- TANK FLEET (Battle City idiom, 16x16, facing UP; use rotate:true). 'X'
  // (no palette entry) = the recolourable HULL → entity colour; 'Y' = the textured
  // tread bands (the alternating notch is the tread links); 'W' = turret detail /
  // shading (the hero's is a gold star). Each tier has a distinct hull/barrel. ---
  tankLight: { // scout: slim notched hull, short barrel (fast)
    grid: [
      "................",
      ".......XX.......",
      "......XXXX......",
    ...
    palette: { Y: "#2a2a2a", W: "#1f2329" },
  },
  tankMedium: { // standard battle tank: plain turret, medium barrel
    grid: [
      "................",
      ".......XX.......",
      ".......XX.......",
  ...
  tankHeavy: { // heavy: wide full-width hull, big turret, thick barrel
    grid: [
      "................",
      "......XXXX......",
      "......XXXX......",
  ...
  tankHero: { // the player's tank: medium hull, turret with a gold STAR insignia
    grid: [
      "................",
      ".......XX.......",
      ".......XX.......",
